/* =============================================================================
   ...
   · Precios: del proceso de alta de gimnasiosxtreme.provis.es.
   · Fotografías: reportaje del propio club (febrero de 2025) publicado en su web.
...
window.__BRAND__ = {
  ...
  clases: [
    {
      ...
      alt: 'Barra olímpica con discos preparada para una clase de Body Pump'
    },
    {
      ...
      alt: 'Sala de ciclo indoor de Gimnasios Xtreme con las bicicletas y la pantalla'
    },
    {
      ...
      alt: 'Socio levantando con barra y discos en la zona de peso libre'
    },
    {
      ...
      alt: 'Sentadilla con barra en el rack de la sala de peso libre'
    },
    {
    ...
    },
    {
      ...
      alt: 'Clase colectiva de Cardio Box en la sala de espejos de Gimnasios Xtreme'
    },
    {
      ...
      alt: 'Plataformas de step apiladas en el pasillo de la sala de clases'
    },
    {
    ...
    },
    {
      ...
      alt: 'Monitor dirigiendo un ejercicio a una socia en la sala de Gimnasios Xtreme'
    },
    {
    ...
    },
    {
      ...
      alt: 'Clase de Body Balance con estiramientos y trabajo de equilibrio'
    },
    {
      ...
      alt: 'Clase de pilates trabajando la musculatura profunda en colchoneta'
    },
    {
    ...
    },
    {
      ...
      texto: 'Técnica de puño y pierna sobre saco y manoplas, con acondicionamiento físico. ' +
             ...
             'Lunes y jueves de 21:00 a 22:30 en Xtreme 1, desde 13 años. Cuota aparte de 41 €.',
      duracion: 90, intensidad: 4, nivel: 'Desde 13 años', calorias: '450-650',
      foto: '/assets/img/clase-kickboxing.webp', fotoFallback: '/assets/img/clase-kickboxing.jpg',
      alt: 'Sala de entrenamiento funcional con tatami donde se dan las clases de kick boxing'
    },
    {
      ...
      texto: 'Judo tradicional en tatami: técnica de pie y de suelo, caídas y randori. ' +
             'Adultos, lunes y miércoles de 17:30 a 19:00. Infantil, martes y jueves de 17:00 ' +
             'a 18:00 (10 a 13 años) y de 18:00 a 19:00 (4 a 9 años). Todo en Xtreme 3, con ' +
             'cuota aparte de 41 € adultos y 34 € infantil.',
      duracion: 90, intensidad: 4, nivel: 'Desde 4 años', calorias: '400-600',
      foto: '/assets/img/clase-judo.webp', fotoFallback: '/assets/img/clase-judo.jpg',
      alt: 'Alumnos de judo entrenando en el tatami del centro Xtreme 3'
    },
    {
      ...
      texto: 'Sistema de defensa personal basado en reacciones naturales: liberaciones, ' +
             'defensas ante agarre y trabajo de distancia. Sin katas ni competición. Martes y ' +
             'jueves de 17:30 a 19:00 en Xtreme 2, desde 13 años. Cuota aparte de 41 €, sin matrícula.',
      duracion: 90, intensidad: 4, nivel: 'Desde 13 años', calorias: '400-600',
      foto: '/assets/img/clase-krav-maga.webp', fotoFallback: '/assets/img/clase-krav-maga.jpg',
      alt: 'Sala de artes marciales acristalada donde se imparte el krav maga'
    }
  ],

  /* ----------------------------------------------------------------- tarifas */
  /* PRECIOS REALES, tomados del sistema de altas del propio club:
     gimnasiosxtreme.provis.es → INSCRIPCIÓN / ALTAS / TARIFAS
     (consultado el 1 de agosto de 2026).

     `precio`      es lo que se paga de una vez por todo el periodo.
     `alMes`       es el equivalente mensual, tal y como lo presenta el club.
     `ahorroAlAno` es lo que se ahorra frente a pagar mes a mes, calculado sobre
                   la cuota mensual real. No se inventa ningún «precio antes»:
                   estas cuotas nunca han costado otra cosa.
     `matricula`   es la tarifa de inscripción de esa cuota concreta. */
  tarifas: {
    titulillo: 'Cuotas',
    titulo: 'Una cuota, tres gimnasios',
    texto: 'Las tres cuotas abren los tres centros las 24 horas, todos los días del año, ' +
           'con todas las clases dirigidas incluidas. Cuanto más largo el periodo, menos ' +
           'pagas al mes.',
    aviso: '',   // los precios están confirmados; si vuelven a moverse, avisa aquí
    moneda: '€',
    planes: [
      {
        id: 'mensual', nombre: 'Mensual', periodo: '/mes',
        precio: 39.90, precioAntes: null, alMes: 39.90,
        matricula: 3.00, ahorroAlAno: 0,
        destacado: false,
        resumen: 'Se renueva sola cada mes. Te das de baja cuando quieras.',
        incluye: [
          'Acceso ilimitado 24 h a los tres gimnasios',
          'Todas las clases dirigidas',
          'Salas de entrenamiento virtual y sauna',
          'Tarifa de inscripción: 3 €'
        ],
        cta: 'Darme de alta'
      },
      {
        id: 'trimestral', nombre: 'Trimestral', periodo: '/3 meses',
        precio: 113.00, precioAntes: null, alMes: 37.67,
        matricula: 0, ahorroAlAno: 26.80,
        destacado: true,
        etiqueta: 'La más elegida',
        resumen: 'Sale a 37,67 € al mes y sin matrícula.',
        incluye: [
          'Todo lo de la cuota mensual',
          'Sin tarifa de inscripción',
          'Se renueva sola cada tres meses',
          'Ahorras 26,80 € al año frente a la mensual'
        ],
        cta: 'Darme de alta'
      },
      {
        id: 'semestral', nombre: 'Semestral', periodo: '/6 meses',
        precio: 205.00, precioAntes: null, alMes: 34.17,
        matricula: 0, ahorroAlAno: 68.80,
        destacado: false,
        etiqueta: 'Mejor precio',
        resumen: 'Sale a 34,17 € al mes. No se puede interrumpir.',
        incluye: [
          'Todo lo de la cuota trimestral',
          'El precio por mes más bajo',
          'Se renueva sola cada seis meses',
          'Ahorras 68,80 € al año frente a la mensual'
        ],
        nota: 'Cuota no interrumpible.',
        cta: 'Darme de alta'
      }
    ],

    /* Sin cuota: para probar el gimnasio o venir de paso */
    extras: [
      { id: 'dia', nombre: 'Entrada de día', precio: 9.00, precioAntes: null,
        nota: 'Válida el día de la compra. Si no tienes llave de acceso, se compra en recepción por 3 € (pago único). No se entregan llaves en festivos, domingos, sábados a partir de las 13:25 ni de lunes a viernes de 14:00 a 16:00.' },
      { id: 'bono-7', nombre: 'Bono de 7 días', precio: 21.90, precioAntes: null,
        nota: 'Empieza el día de la compra y caduca a los 7 días. Incluye pulsera de acceso a los tres gimnasios. No incluye artes marciales.' },
      { id: 'bono-15', nombre: 'Bono de 15 días', precio: 29.90, precioAntes: null,
        nota: 'Empieza el día de la compra y caduca a los 15 días. Incluye pulsera de acceso a los tres gimnasios. No incluye artes marciales.' },
      { id: 'llave', nombre: 'Llave de acceso', precio: 3.00, precioAntes: null,
        nota: 'Pago único. Es lo que abre la puerta fuera del horario de recepción.' }
    ],

    /* Cuotas de artes marciales: van aparte de la cuota general, con su propio
       horario y su propia sala. Precios y horarios del sistema de altas. */
    artesMarciales: {
      titulo: 'Artes marciales',
      texto: 'Tienen cuota propia, con horario y sala fijos. Si además quieres las salas de ' +
             'fitness, las clases y la sauna de los tres gimnasios, el arte marcial te sale ' +
             'a mitad de precio: pregunta en recepción.',
      cuotas: [
        { id: 'judo-adultos', nombre: 'Judo adultos', precio: 41.00, matricula: 21.00,
          centro: 'xtreme-3', horario: 'Lunes y miércoles, 17:30–19:00', edad: 'Desde 13 años' },
        { id: 'judo-infantil', nombre: 'Judo infantil', precio: 34.00, matricula: 21.00,
          centro: 'xtreme-3', horario: 'Martes y jueves, 17:00–18:00 (10 a 13 años) y 18:00–19:00 (4 a 9 años)',
          edad: 'De 4 a 13 años', nota: 'Plazas limitadas a 25 alumnos por turno.' },
        { id: 'kickboxing', nombre: 'Kick Boxing', precio: 41.00, matricula: 21.00,
          centro: 'xtreme-1', horario: 'Lunes y jueves, 21:00–22:30', edad: 'Desde 13 años' },
        { id: 'krav-maga', nombre: 'Krav Maga · defensa personal', precio: 41.00, matricula: 0,
          centro: 'xtreme-2', horario: 'Martes y jueves, 17:30–19:00', edad: 'Desde 13 años' },
        { id: 'taekwondo', nombre: 'Taekwondo', precio: 34.00, matricula: 21.00,
          centro: 'xtreme-1', horario: 'Lunes y miércoles, 17:00–18:00 (desde 12 años) y 18:00–19:00 (4 a 11 años). Martes y jueves, 17:00–18:00 (12 a 18 años) y 18:00–19:00 (4 a 8 años)',
          edad: 'Desde 4 años' }
      ],
      nota: 'El primer mes la cuota se prorratea según el día de alta.'
    },

    /* Judo en colegios: se paga al club pero la clase es en el propio colegio */
    judoColegios: {
      titulo: 'Judo en colegios',
      texto: 'Judo dentro del propio colegio, con cuota mensual y sin matrícula. Incluye ' +
             'acceso al canal de spinning y clases colectivas desde el área privada.',
      precio: 26.00,
      colegios: [
        { nombre: 'Antonio Machado', horario: 'Lunes y miércoles, 16:00–17:00' },
        { nombre: 'Claudio Sánchez Albornoz', horario: 'Martes y jueves, 16:00–17:00' },
        { nombre: 'Río Arlanzón', horario: 'Lunes y miércoles, 15:30–16:30' },
        { nombre: 'Solar del Cid', horario: 'Lunes y miércoles, 17:00–18:00' },
        { nombre: 'Venerables', horario: 'Martes y jueves, 15:30–16:30' }
      ]
    },

    /* Colectivos con precio especial. Los datos son los del club. */
    descuentosColectivo: [
      { nombre: 'Familia', porcentaje: 50,
        nota: 'Cónyuges e hijos de 14 a 22 años. El primero paga su cuota completa; el resto, ' +
              'la mensual a mitad de precio. Hay que acreditar el parentesco con el libro de ' +
              'familia o el documento de pareja de hecho. Artes marciales excluidas.' },
      { nombre: 'De 14 a 17 años', porcentaje: 0,
        precioDesde: 39.90,
        nota: 'Mismas cuotas que la general (39,90 € al mes, 113 € el trimestre, 205 € el ' +
              'semestre), con acceso de 06:00 a 24:00 en vez de 24 horas.' },
      { nombre: 'Vuelves antes de 3 meses', porcentaje: 0,
        nota: 'Si has sido socio y llevas menos de tres meses de baja, la matrícula se te ' +
              'descuenta en cuanto te identifiques.' }
    ],

    letraPequena: 'Precios con IVA incluido, tomados del sistema de altas del club el 1 de ' +
                  'agosto de 2026. La cuota general da acceso a los tres centros las 24 horas ' +
                  'del día, todos los días del año. Las cuotas se renuevan automáticamente al ' +
                  'final de cada periodo. Las clases dirigidas requieren reserva de plaza y ' +
                  'están sujetas a aforo. Las artes marciales tienen cuota aparte.'
  },

  /* --------------------------------------------------------------- promoción */
  /* Franja de oferta que cruza el sitio. Pon `activa: false` y desaparece.
     El texto es el que el propio club anuncia en su sistema de altas. */
  promocion: {
    activa: true,
    titulo: 'La trimestral y la semestral salen más baratas al mes',
    texto: 'Desde 34,17 € al mes en los tres gimnasios, 24 horas todo el año.',
  ...
  agenda: {
    ...
    /* Las artes marciales llevan el horario REAL del sistema de altas del club.
       El resto de clases dirigidas es una propuesta coherente con «más de 40 a
       la semana»: pide el cuadro real y sustituye esas líneas. */
    demo: true,
    notaDemo: 'Las artes marciales llevan el horario real del club. El resto es una propuesta.',
    plazasPorDefecto: 24,
    horario: [
      ...
      /* --- Artes marciales: horarios REALES del sistema de altas del club --- */
      { dia: 1, hora: '17:30', clase: 'judo',        centro: 'xtreme-3', monitor: '', plazas: 25 },
      { dia: 3, hora: '17:30', clase: 'judo',        centro: 'xtreme-3', monitor: '', plazas: 25 },
      { dia: 2, hora: '17:00', clase: 'judo',        centro: 'xtreme-3', monitor: '', plazas: 25 },
      { dia: 4, hora: '17:00', clase: 'judo',        centro: 'xtreme-3', monitor: '', plazas: 25 },
      { dia: 1, hora: '21:00', clase: 'kick-boxing', centro: 'xtreme-1', monitor: '', plazas: 25 },
      { dia: 4, hora: '21:00', clase: 'kick-boxing', centro: 'xtreme-1', monitor: '', plazas: 25 },
      { dia: 2, hora: '17:30', clase: 'krav-maga',   centro: 'xtreme-2', monitor: '', plazas: 20 },
      { dia: 4, hora: '17:30', clase: 'krav-maga',   centro: 'xtreme-2', monitor: '', plazas: 20 }
    ]
  },
  ...
  galeria: {
    ...
    fotos: [
      { src: '/assets/img/gal-01.webp', fallback: '/assets/img/gal-01.jpg', alt: 'Sala principal de fitness de Gimnasios Xtreme con las máquinas guiadas', ancho: 1024, alto: 768 },
      { src: '/assets/img/gal-02.webp', fallback: '/assets/img/gal-02.jpg', alt: 'Rack de mancuernas de la zona de peso libre', ancho: 1200, alto: 772 },
      { src: '/assets/img/gal-03.webp', fallback: '/assets/img/gal-03.jpg', alt: 'Sala de ciclo indoor de Gimnasios Xtreme con las bicicletas y la pantalla', ancho: 1200, alto: 800 },
      { src: '/assets/img/gal-04.webp', fallback: '/assets/img/gal-04.jpg', alt: 'Socio entrenando con barra y discos en la sala de peso libre', ancho: 1200, alto: 800 },
      { src: '/assets/img/gal-05.webp', fallback: '/assets/img/gal-05.jpg', alt: 'Clase colectiva en marcha en la sala de actividades dirigidas', ancho: 1200, alto: 630 },
      { src: '/assets/img/gal-06.webp', fallback: '/assets/img/gal-06.jpg', alt: 'Rack de kettlebells de la zona de entrenamiento funcional', ancho: 1200, alto: 813 },
      { src: '/assets/img/gal-07.webp', fallback: '/assets/img/gal-07.jpg', alt: 'Hilera de cintas de correr y elípticas en la zona de cardio', ancho: 1200, alto: 805 },
      { src: '/assets/img/gal-08.webp', fallback: '/assets/img/gal-08.jpg', alt: 'Alumnos de artes marciales entrenando en el tatami', ancho: 1170, alto: 780 }
    ]
  },
  ...
  /* ------------------------------------------------------------------- panel */
  /* El panel (carpeta panel/) se abre con cuenta de Supabase: aquí no hay
     ninguna clave. Ver README.md → «Dar acceso al panel». */
  panel: {
    titulo: 'Panel de gestión',
    texto: 'Citas, clases, mensajes y el contenido de la web. Al publicar, la web se ' +
           'actualiza sola.'
  },
