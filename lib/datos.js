/* =============================================================================
   ...
   -----------------------------------------------------------------------------
   Sirve para que dos personas no cojan la misma hora de cita en el mismo
   centro, y para que el aforo de cada clase sea el mismo para todos los socios.
   Las franjas, los centros y el horario los comprueba el servidor con el
   contenido publicado desde el panel.

   Habla directamente con la API de Supabase por fetch, sin cargar su librería:
   la web solo necesita llamar a tres funciones y leer dos listas.
